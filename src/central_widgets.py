    ...
    def setupVTK(self):
        ...
        vertexShader = """
            ...
            void main(){
                ...
                // This just has to return the uvCoordinate/u_resolution
                return fragCoord;
            }
        ...
        self.shaderProperty = self.mapper.getShaderProperty()
        
        # 
        self.shaderProperty.replaceShaderProperty(
            vtk.vtkShaderType().Fragment,
            True,
            //VTK::Normal::Dec,
            vertexShader,
            False
        ...
        self.renderer.replaceShaderProperty(
            vtk.vtkShaderType().Vertex,
            True,
            //VTK::Normal::Impl,
            fragmentShader,
            False
